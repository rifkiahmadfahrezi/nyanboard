  ...
  return (
    <div className="min-h-screen w-full flex flex-col gap-10 items-center justify-center px-6 py-16">
      ...
      <figure className="w-full max-w-screen-xl mx-auto aspect-video relative">
        <div className="absolute w-full h-64 bg-gradient-to-t from-primary/75 dark:from-primary/30 to-transparent -top-24 left-0 -z-10"></div>
        <div className="overflow-hidden border-2 rounded-xl z-20">
          <Image
            ...
            width={600}
            height={300}
            className="w-full h-full object-contain z-20 dark:block hidden"
            alt="hero image"
          />
          <Image
            priority
            ...
            width={600}
            height={300}
            className="w-full h-full object-contain z-20 dark:hidden block"
            alt="hero image"
          />
        </div>
      </figure>
