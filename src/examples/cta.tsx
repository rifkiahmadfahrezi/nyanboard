    ...
    <Card className="px-8 isolate py-20 relative max-w-screen-lg mx-auto my-10 flex flex-wrap gap-3 items-center justify-between overflow-hidden after:content-[''] after:size-[500px] after:absolute after:-bottom-[100%] after:left-2/4 after:-translate-x-2/4 after:translate-y-6 after:z-10 after:bg-radial after:from-primary/30 after:to-transparent after:from-10% after:to-60% after:rounded-full">
      <div className="space-y-3 z-20">
        ...
        <p className="max-w-md text-muted-foreground">
          ...
          exercitationem dignissimos tenetur quos placeat.
        </p>
